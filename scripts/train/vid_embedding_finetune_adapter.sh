...
VISION_MODEL_VERSION="video_embedding_videoMAE_patch"
...
BASE_RUN_NAME="videoMAE_Patch_videoLLaVA_finetune_only-adapters-${VISION_MODEL_VERSION//\//_}-${LLM_VERSION//\//_}"
