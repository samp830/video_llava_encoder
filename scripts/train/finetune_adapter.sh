...
# Previously used 16-patch CLIP, requires reshape to concat
...
BASE_RUN_NAME="videoLlaVa14PatchCLIPBaselinefinetune_only-adapters-${VISION_MODEL_VERSION//\//_}-${LLM_VERSION//\//_}"
...
ACCELERATE_CPU_AFFINITY=1 torchrun --nproc_per_node=8 --nnodes=1 --node_rank=0 --master_addr=localhost --master_port=29503 \
